...
class FavoriteAdapter(private val context: Context): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    private fun updateFavoriteItemViewHolder(holder: FavoriteItemViewHolder, position: Int) {
        ...
        var url = CouponUrls(pc = data.url,sp=data.url)
        var shop = Shop(id = data.id,name= data.name,address = data.address,logoImage = data.imageUrl,couponUrls = url )
        ...
        holder.apply {
            rootView.apply {
                ...
                setOnClickListener {
                    ...
                    //onClickItem?.invoke(favoriteShop.url)
                }
            }
            nameTextView.text = data.name
            addressTextView.text = data.address //追加
    ...
    class FavoriteItemViewHolder(view: View): RecyclerView.ViewHolder(view) {
        ...
        val addressTextView: TextView = view.findViewById(R.id.addressTextView) //追加
    }
